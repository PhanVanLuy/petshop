export class UrlConstants {
    ...
    public static COOKIE_POLICY = 'cookie-policy';
    public static REFUND_POLICY = 'refund-policy';
    public static TERMS_CONDITIONS = 'terms-conditions';
    public static USER_POLICY = 'user-policy';
